...
export function IncidentMap({ reports, selectedId, onSelect }: { reports: ReportSummary[]; selectedId: number | null; onSelect: (r: ReportSummary) => void }) {
